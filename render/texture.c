/* texture.c  -  Render library  -  Public Domain  -  2014 Mattias Jansson
 *
...
render_texture_allocate(void) {
	render_texture_t* texture = memory_allocate(HASH_RENDER, sizeof(render_texture_t), 16, MEMORY_PERSISTENT);
