...
#if 0
static render_parameter_block_t* _rb_gl4_allocate_parameter_block(render_backend_t* backend,
...
static void _rb_gl4_bind_parameter_block(render_backend_t* backend, render_parameter_block_t* block,
                                         unsigned int index, const void* RESTRICT data) {
}


static void _rb_gl4_deallocate_parameter_block(render_backend_t* backend,
